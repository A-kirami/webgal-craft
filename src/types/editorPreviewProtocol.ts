...
function definePayloadMap<const TMap extends PayloadMap>(map: TMap): Readonly<TMap> {
...
export type PreviewResponsePayloadByType =
...
export const PREVIEW_REQUEST_ERROR_CODES = [
  'bad-request',
