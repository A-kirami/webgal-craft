...
export interface SetComponentVisibilityPayload {
  showStarter?: boolean
  showTitle?: boolean
...
export type PreviewRequestType = PreviewCommandType
...
export interface RequestPayloadByType extends SessionRequestPayloadByType, PreviewCommandPayloadByType {}

interface SessionResponsePayloadByType {
  'session.register-preview': EmptyObject
}

interface ResponsePayloadByType extends SessionResponsePayloadByType, Record<PreviewCommandType, EmptyObject> {}
...
function isMessageType<TType extends string>(
  value: unknown,
  acceptedTypes: readonly TType[],
): value is TType {
