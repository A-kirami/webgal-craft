...
const ERROR_CODES = [
  // 后端 Rust 侧错误码
  'IO_ERROR', 'IMAGE_ERROR', 'SERVER_ERROR', 'CONFIG_ERROR', 'WINDOW_ERROR', 'EXPORT_ERROR', 'TAURI_ERROR',
  ...
  'PATH_OPERATION', 'INVALID_ARCHIVE', 'UNSUPPORTED_ARCHIVE',
  'INVALID_CONFIG', 'INVALID_MANIFEST', 'TARGET_CONFLICT', 'RESOURCE_IN_USE', 'MISSING_TEMPLATE',
  'ENGINE_EDITOR_INCOMPATIBLE',
  'PROVIDER_DENIED', 'COPY_FAILED', 'UNSAFE_ENTRY', 'RESOURCE_LIMIT', 'STORAGE_FULL', 'ROLLBACK_FAILED',
] as const
