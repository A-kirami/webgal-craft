...
export const performEntries: CommandEntry[] = [
  {
    ...
    fields: [
        ...
        autocomplete: [
          {
            ...
            options: [
              ...
              { label: t => t('edit.visualEditor.options.figureLeft14'), value: FIGURE_POSITION_TARGET_IDS.left14 },
              { label: t => t('edit.visualEditor.options.figureLeft13'), value: FIGURE_POSITION_TARGET_IDS.left13 },
              { label: t => t('edit.visualEditor.options.figureCenter'), value: FIGURE_POSITION_TARGET_IDS.center },
              { label: t => t('edit.visualEditor.options.figureRight13'), value: FIGURE_POSITION_TARGET_IDS.right13 },
              { label: t => t('edit.visualEditor.options.figureRight14'), value: FIGURE_POSITION_TARGET_IDS.right14 },
      ...
      arg({ key: 'concat', label: t => t('edit.visualEditor.params.concat'), tooltip: { on: t => t('edit.visualEditor.paramTooltips.concat.on'), off: t => t('edit.visualEditor.paramTooltips.concat.off') }, type: 'switch', defaultValue: false }),
      arg({ key: 'notend', label: t => t('edit.visualEditor.params.notend'), tooltip: { on: t => t('edit.visualEditor.paramTooltips.notend.on'), off: t => t('edit.visualEditor.paramTooltips.notend.off') }, type: 'switch', defaultValue: false }),
    ],
  },
  {
