import { installTextEditorHistoryAdapter } from '~/features/editor/text-editor/text-editor-history-adapter'
import {
...
} from '~/features/editor/text-editor/text-editor-history-snapshot'
